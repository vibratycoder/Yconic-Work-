...
MARCUS_LABS = [
    # ── November 2024 — most recent panel (comprehensive metabolic + CBC + extras) ──
    {
        "user_id": DEMO_USER_ID,
        "test_name": "HbA1c",
        "loinc_code": "4548-4",
    ...
    # Liver enzymes — borderline high on atorvastatin
    {
        "user_id": DEMO_USER_ID,
        "test_name": "ALT",
        "loinc_code": "1742-6",
    ...
    # Vitamins — low Vitamin D common in T2DM; low-normal B12 from metformin depletion
    {
        "user_id": DEMO_USER_ID,
    ...
    # Inflammatory marker — elevated in metabolic syndrome
    {
        "user_id": DEMO_USER_ID,
        "test_name": "hsCRP",
        "loinc_code": "30522-7",
        ...
        "unit": "mg/L",
        "reference_range_low": None,
        "reference_range_high": 1.0,
        "status": "high",
        "date_collected": "2024-11-15",
        "lab_source": "manual",
    },
    # Uric acid — borderline, common with metabolic syndrome
    {
        "user_id": DEMO_USER_ID,
        "test_name": "Uric Acid",
        "loinc_code": "3084-1",
        ...
        "reference_range_high": 7.2,
        "status": "normal",
        "date_collected": "2024-11-15",
        "lab_source": "manual",
    },

    # ── May 2024 — 6-month prior panel (slightly worse — trend improving) ──
    {
        "user_id": DEMO_USER_ID,
        "test_name": "HbA1c",
        "loinc_code": "4548-4",
    ...
    # ── November 2023 — baseline panel (worst point, before medication optimisation) ──
    {
        "user_id": DEMO_USER_ID,
        "test_name": "HbA1c",
        "loinc_code": "4548-4",
